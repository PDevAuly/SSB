  ...
  return (
    <>
      ...
      <main className="py-10">
        ...
        {/* 02 SERVICES — Kacheln mit Reveal */}
        <section id="services" className="scroll-mt-24">
          <div className="mx-auto w-[min(1600px,calc(100vw-2rem))] px-4 sm:px-6 lg:px-8 mt-14">
            <Reveal>
  ...
  <Reveal key={c.t} delay={0.05 * i}>
    <Link
      ...
      className={[
        ...
        "platinum-hover", // dein dunkles Silber
      ].join(" ")}
    >
      <div className="text-base font-semibold text-slate-100 transition-colors duration-300 group-hover:text-black">
        {c.t}
      </div>
      <div className="text-slate-300 mt-1 transition-colors duration-300 group-hover:text-slate-900">
        {c.d}
      </div>

      {/* Fokusring für Tastatur-User */}
      <span className="absolute inset-0 rounded-2xl ring-0 ring-blue-500/0 group-focus-visible:ring-2 group-focus-visible:ring-blue-400/60 pointer-events-none" />
    </Link>
  </Reveal>
))}
        ...
        {/* 03 ABOUT — kurzer Teaser im dunklen Block */}
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-8">
              <Reveal y={16}>
                ...
                <p className="text-slate-300 mt-3 max-w-2xl">
                  SSB – Soulé Smart Business. Wir verbinden Design, Entwicklung und KI zu messbaren Ergebnissen.
                </p>
              </Reveal>
            </div>
          </div>
